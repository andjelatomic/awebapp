...
Anyhow, this is small example I've made as a part of an asignment, very quickly, in less then half of a day, just to show posibilities on how to use Python, FastAPI, SQLITE, SQLAlchemy to build simple website.
